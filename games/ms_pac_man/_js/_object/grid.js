...
let grid = {
	...
	[{b:"b"},{b:"b"},{w:"w"},{f:"s"},{w:"w"},{w:"w"},{w:"w"},{w:"w"},{w:"w"},{p:"b"},{w:"w"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{w:"w"},{p:"b"},{w:"w"},{w:"w"},{w:"w"},{w:"w"},{w:"w"},{f:"s"},{w:"w"},{b:"b"},{b:"b"}],
	[{b:"b"},{b:"b"},{w:"w"},{f:"s"},{w:"w"},{w:"w"},{f:"s"},{p:"b"},{p:"b"},{p:"b"},{w:"w"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{w:"w"},{p:"b"},{p:"b"},{p:"b"},{f:"s"},{w:"w"},{w:"w"},{f:"s"},{w:"w"},{b:"b"},{b:"b"}], 
	[{b:"b"},{b:"b"},{w:"w"},{f:"s"},{w:"w"},{w:"w"},{f:"s"},{w:"w"},{w:"w"},{p:"b"},{w:"w"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{c:"b"},{w:"w"},{p:"b"},{w:"w"},{w:"w"},{f:"s"},{w:"w"},{w:"w"},{f:"s"},{w:"w"},{b:"b"},{b:"b"}],
